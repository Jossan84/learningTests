/*
 *   SfcnProcessFunction.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void ProcessFunction(double u1[1], double u2[1], double y1[2], double y2[1])
 *
 *   Simulink version           : 8.7 (R2016a) 10-Feb-2016
 *   C source code generated on : 06-Jul-2020 16:34:38
 ...
 */
#define S_FUNCTION_NAME                SfcnProcessFunction
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "ProcessFunctionInit", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "ProcessFunction", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
