...
%   MATLAB file generated on : 06-Jul-2020 16:34:40
...
% Dependency info for S-function 'SfcnProcessFunction'
info(1).SFunctionName = 'SfcnProcessFunction';
info(1).IncPaths = {'E:\Develop\Workspace_Matlab\TestSFunctionSimulinkLib\libs\windowsSDK\include', 'E:\Develop\Workspace_Matlab\TestSFunctionSimulinkLib\SFunction'};
info(1).SrcPaths = {'E:\Develop\Workspace_Matlab\TestSFunctionSimulinkLib\SFunction'};
info(1).LibPaths = {'E:\Develop\Workspace_Matlab\TestSFunctionSimulinkLib\libs\windowsSDK\lib'};
info(1).SourceFiles = {'ProcessFunction.c'};
info(1).HostLibFiles = {'sumDouble_rtwlib'};
info(1).TargetLibFiles = {'sumDouble_rtwlib'};
info(1).Language = 'C';
