...
#
#  $RCSfile: TestSFunctionLib.mk $ $Revision: 2.95 $ $Date: 2016/03/14 14:26:10MEZ $
...
COMPUTER                       = PCWIN64
MODEL                          = TestSFunctionLib
MODULES                        = ProcessFunction.c TestSFunctionLib_data.c TestSFunctionLib_trc_ptr.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = $(START_DIR)\libs\dspace\lib\libmatrix.a
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
NCSTATES                       = 0
...
RTWCUST_INCLUDES = \
	...
	"$(START_DIR)\TestSFunctionLib_rti1401" \
	"$(START_DIR)" \
	"$(START_DIR)\SFunction" \
	"$(START_DIR)\libs\dspace\lib"
