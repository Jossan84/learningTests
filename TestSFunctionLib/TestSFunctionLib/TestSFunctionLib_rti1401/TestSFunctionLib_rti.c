/*********************** dSPACE target specific file *************************
   ...
   Include file TestSFunctionLib_rti.c:
...
#define RTB_STRUCTURE_NAME             TestSFunctionLib_B
#define RTP_STRUCTURE_NAME             TestSFunctionLib_P
