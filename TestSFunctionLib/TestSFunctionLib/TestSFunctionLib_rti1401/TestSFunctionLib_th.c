/************************ dSPACE target specific file *************************
   ...
   Include file .\TestSFunctionLib_rti1401\TestSFunctionLib_th.c :

   Task Configuration file for model : TestSFunctionLib

   RTI1401 7.7 (02-Nov-2016)/2.17
   23-Jun-2020 18:20:04
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [1 0] s           : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\TestSFunctionLib_rti1401\TestSFunctionLib_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (1 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
