###########################################################################
## Makefile generated for Simulink model 'testSimulinkLibrary'. 
## 
## Makefile     : testSimulinkLibrary.mk
## Generated on : Thu Jul 02 18:31:34 2020
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\testSimulinkLibrary.exe
...
PRODUCT_NAME              = testSimulinkLibrary
MAKEFILE                  = testSimulinkLibrary.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testSimulinkLibrary_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = testSimulinkLibrary_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\testSimulinkLibrary.exe
...
DEFINES_STANDARD = -DMODEL=testSimulinkLibrary -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\testSimulinkLibrary_grt_rtw\testSimulinkLibrary.c $(START_DIR)\testSimulinkLibrary_grt_rtw\testSimulinkLibrary_data.c rt_logging.c
...
OBJS = testSimulinkLibrary.obj testSimulinkLibrary_data.obj rt_logging.obj
...
MODELREF_LIBS = .\sumDouble_rtwlib.lib
...
{$(START_DIR)\testSimulinkLibrary_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\testSimulinkLibrary_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
