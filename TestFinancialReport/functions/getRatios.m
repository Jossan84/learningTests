...
##    ratios.PriceCashFlow{i} = financialData.price{i}/financialData.freeCashFlow{i};
...
##    ratios.ROE{i} = financialData.netIncomeFromContinuingAndDiscontinuedOperation{i}/financialData.commonStockEquity{i};
##    ratios.RelatedPer{i} = ratios.PriceToBookValue{i}/ratios.ROE{i};
##    ratios.ROA{i} = financialData.netIncomeFromContinuingAndDiscontinuedOperation{i}/financialData.totalAssets{i};
